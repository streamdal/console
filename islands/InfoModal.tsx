...
export default function InfoModal(
  { params, pipelines, serviceMap, success }: {
    params: Params;
  ...
  // stubbed dummy data in the shape of our new getAll:
  ...
  const handleChange = (id) => {
    const newPipelineName = Object.keys(dummyPipelines).find((name) =>
      dummyPipelines[name].pipeline.id === id
    );
    setLinkedPipeline(dummyPipelines[newPipelineName].pipeline);
  };
                ...
                {!Object.keys(dummyPipelines).length
                  ...
                  ? (
                    <button
                      ...
                      className="text-white border border-gray-600 font-medium rounded-sm w-full flex justify-between text-sm px-2 text-xs py-1 text-center inline-flex items-center"
                      type="button"
                        ...
                        {Object.keys(dummyPipelines).map((
                          ...
                          <div class="flex items-center py-2 px-2 hover:bg-purple-50">
                            <input
                              ...
                              onChange={() =>
                                handleChange(
                                  dummyPipelines[pipeline].pipeline.id,
                                )}
