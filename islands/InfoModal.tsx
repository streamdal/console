                 ...
                 class="z-50 bg-white  absolute right-[325px] divide-gray-100 rounded-md shadow w-[200px] dark:bg-gray-700">
                  ...
                  >
                    {pipelines.map((pipeline: any, i: number) => (
                      ...
                      // <li>
                      //   <a
                      //     href={`${params.operationName}/pipeline/${pipeline.id}/attach-detach`}
                      //   >
                      //     <button
                      ...
                      //       data-tooltip-placement="top"
                      //       type="button"
                      //       className={`px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white flex justify-start text-left w-full ${
