...
import {peekingSignal, peekSamplingRateSignal, peekSamplingSignal,} from "../lib/peek.ts";
                                    ...
                                    >
                                        <div>
                                            <div class="rounded-t flex justify-between">
                                                <div
                                                    class="z-[20] flex items-center justify-start px-4 w-full h-16 bg-web">
                                                    {opType === "CONSUMER"
                                            ...
                                            <div class="px-4 py-4 rounded-md mx-2">
                                                ...
                                                {!serviceMap?.pipes.length
                                                    ? (
                                                        <a href={"/pipelines"}>
                                                            <button
                                                                class="text-streamdalPurple border border-purple-600 bg-purple-50 font-semibold rounded-lg w-full flex justify-center text-sm px-2 py-1 text-center inline-flex items-center">
                                        ...
                                        <span className="mr-3 text-[12px] font-[500] leading-[20px] text-cobweb">
                                          Sample Setting
                                                                                ...
                                                                                />
                                                                                <span
                                                                                    className="mr-3 text-[12px] font-[500] leading-[20px] text-cobweb">
                                          /s
                                        </span>
                                                                            </label>
                                                                        )}
