                                            ...
                                            <div class="px-4 py-4 rounded mx-2">
                                                ...
                                                {!serviceMap?.pipes.length
                                                    ? (
                                                        <a href={"/pipelines"}>
                                                            <button
                                                                class="text-web border border-purple-600 bg-purple-50 font-medium rounded-sm w-full flex justify-center text-sm px-2 text-xs py-1 text-center inline-flex items-center">
